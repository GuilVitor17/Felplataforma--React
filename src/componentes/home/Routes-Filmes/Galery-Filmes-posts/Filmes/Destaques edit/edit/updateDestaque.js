...
const filmesUpdateDestaque = (filmessUpdate) => {
    ...
    const Update = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_BASE_URL_GALERY}/filmescarrossel/${id}`, {
            titulo: Titulo,
            diretor: Diretor,
            duracao: Duracao,
        ...
        .then(async data => {
          let timerInterval
          await Swal.fire({
            title: 'ATUALIZANDO LIVRO DESTAQUE !',
            html: 'AGUARDE <b></b>',
            timer: 2000,
    ...
    return (
        <section className="formulario">
            <div>
                <form class="row g-3" onSubmit={Update}>
                    ...
                    <h6>Editar filmes em Destaque</h6>
                    <div class="col-md-4">
        ...
        <div class="col-md-3">
          <label for="inputEmail4" class="form-label">Genero do filme</label>
          <input type="text" onChange={handleGenero} placeholder="URL - MAX 50KB" value={Genero} class="form-control" id="inputEmail4" />
        </div>
        <div class="col-5">
   ...
   <input type="text" class="form-control" onChange={handleDescricao} required placeholder="DESCRIÇAO DETALHADA DO LIVRO" maxLength={150}  value={Descricao} id="inputAddress2" />
        ...
        <div class="col-md-2">
          ...
          <input type="text" onChange={handleAtorImage5} required placeholder="NOME AUTOR " value={ImageAtor5} class="form-control" id="inputCity" />
                    ...
                    <div class="col-6">
                        <button type="submit" class="btn btn-primary">CRIAR filmes DE Destaque</button>
