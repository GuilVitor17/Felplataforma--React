...
const FilmeUpdateComedia = (FilmeUpdate) => {
  ...
  const handleAtor5Filme = (e)=>{
    ...
    const Update = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia3/${id}`, {
      titulo: Titulo,
      diretor: Diretor,
      duracao: Duracao,
      ...
      await Swal.fire({
          position: 'top-end',
          icon: 'success',
          title: `LIVRO COMEDIA 3 ATUALIZADO`,
        ...
        <section className="formulario">
            <div>
                <form class="row g-3" onSubmit={Update}>
                    ...
                    <h5>Editar Filme em Comedia 3</h5>
                    <div class="col-md-4">
   ...
   <input type="text" class="form-control" onChange={handleDescricao} required placeholder="DESCRIÇAO DETALHADA DO LIVRO" maxLength={150}  value={Descricao} id="inputAddress2" />
        ...
        <div class="col-md-2">
          ...
          <input type="text" onChange={handleAtorImage5} required placeholder="NOME AUTOR " value={ImageAtor5} class="form-control" id="inputCity" />
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">CRIAR Filme DE COMEDIA 3</button>
