...
const LivrosComediaInfomacoes = ({titulo, img,Id ,descricaoMin, data}) => {
 ...
 axios.delete(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia1/${Id}`, {
...
.then(async response => {
  let timerInterval
      ...
      await Swal.fire({
          position: 'top-end',
          icon: 'success',
          title: `FILME COMEDIA 1 EXCLUIDO`,
    ...
    <div className="Comedia">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="button-editar" to={`/filmess/comediaedita1/${Id}`}><button>Editar</button></Link>
