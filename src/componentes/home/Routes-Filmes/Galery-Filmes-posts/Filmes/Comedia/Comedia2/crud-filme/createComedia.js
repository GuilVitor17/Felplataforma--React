...
const createComedia = () => {
  ...
  const aoSalvar = (evento) => {
    ...
    axios.post(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia2`, {
      titulo: Titulo,
      diretor: Diretor,
      duracao: Duracao,
  ...
  return (
    <section className="formulario">
      <form class="row g-3" onSubmit={aoSalvar}>
        ...
        <h5>publicar Filme Comedia 2</h5>
        <div class="col-md-4">
