...
const filmesAcao1Infomacoes = ({titulo, img,Id ,descricaoMin, data}) => {
    ...
    <div className="Acao">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="button-editar" to={`updateacao/${Id}`}><button>Editar</button></Link>
...
export default filmesAcao1Infomacoes