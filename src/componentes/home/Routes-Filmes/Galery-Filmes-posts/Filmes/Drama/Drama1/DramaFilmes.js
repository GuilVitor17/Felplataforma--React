...
const filmesDramaInfomacoes = ({titulo, img,Id ,descricaoMin, data}) => {
     ...
     axios.delete(`${process.env.REACT_APP_BASE_URL_GALERY}/filmedrama1/${Id}`, {
    ...
    <div className="Drama">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="Btn-filmes" to={`/Filmes/dramas1/${Id}`}><button type="button" onClick={saveId} className="btn btn-primary">
                    Ver filmes
                  </button></Link>
                  <div className="button-crud">
                  <Link className="button-editar" to={`/filmess/dramaedita1/${Id}`}><button>Editar</button></Link>
