...
const FilmesUpdateromance = (filmesUpdate) => {
    ...
    const Update = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_BASE_URL_GALERY}/romance/${id}`, {
            titulo: Titulo,
            diretor: Diretor,
            duracao: Duracao,
      ...
      await Swal.fire({
          position: 'top-end',
          icon: 'success',
          title: `LIVRO ROMANCE ATUALIZADO`,
    ...
    return (
        <section className="formulario">
          ...
          <path fill-rule="evenodd" d="M15 2a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2zM0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2zm11.5 5.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z" />
                    ...
                    <h5>Editar filmes em ROMANCE</h5>
                    <div class="col-md-4">
   ...
   <input type="text" class="form-control" onChange={handleDescricao} required placeholder="DESCRIÇAO DETALHADA DO LIVRO" maxLength={150}  value={Descricao} id="inputAddress2" />
        ...
        <div class="col-md-2">
          ...
          <input type="text" onChange={handleAtorImage5} required placeholder="NOME AUTOR " value={ImageAtor5} class="form-control" id="inputCity" />
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">EDITAR filmes DE Romance</button>
