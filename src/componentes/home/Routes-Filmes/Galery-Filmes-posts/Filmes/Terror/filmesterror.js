...
const filmesTerrorInfomacoes = ({titulo, img,Id ,descricaoMin, data}) => {
 ...
 axios.delete(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeterror/${Id}`, {
    ...
    <div className="Terror">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="button-editar" to={`updateterrorfilmes/${Id}`}><button>Editar</button></Link>
