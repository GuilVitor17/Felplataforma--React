...
// import Religiaofilmes from "../Religiao/Religiao";
...
const filmesPorIdAcao = () => {
 ...
 fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia/${user}`, {
          method: 'GET',
          headers: {
        ...
        <div className="div-inf-livro">
          ...
          <div className="center-infor-livro">
            ...
            <div className="description-id">
              ...
              <a href={filmes.linkLivro}><div className="button-livro-id"><button>BAIXAR </button></div></a>
            </div>
