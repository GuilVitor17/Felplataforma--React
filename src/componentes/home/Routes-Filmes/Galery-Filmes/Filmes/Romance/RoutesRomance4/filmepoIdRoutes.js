...
import Romancefilmes from "../Romance";
...
const filmesPorIdRoutes = () => {
    ...
    useEffect(()=>{ 
      ...
      const fetchUsers = async () => { 
       ...
       await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeromance4/${user}`, {
           method:'GET',
           headers:{
...
fetchUsers();
  ...
  return (
    <div className="Romance">
          ...
          <Link className='Voltar' to='/filmes/romances'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
