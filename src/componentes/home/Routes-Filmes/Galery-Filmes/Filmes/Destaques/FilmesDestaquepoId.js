...
import FilmesRomance from "../Romance/Romance";


const FilmesDestaquePorId = () => {
  ...
  useEffect(()=>{ 
    const fetchUsers = async () => { 
     ...
     await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmescarrossel/${user}`, {
        method:'GET',
        headers:{
      ...
      <div className="div-Id-livro">
        ...
        <div className="div-inf-livro">
          <div className="div-voltar">
            <Link className='Voltar' to='/filmes/destaques'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
          ...
          <div className="center-infor-livro">
            ...
            <div className="div-caixa-img">
              ...
              <div className="div-inf-id">
                ...
                <p>DURACAO - {filmes.duracao} </p>
                <p>ANO - {filmes.ano}</p>
                <p>DATA - {filmes.data}</p>
                <p>GENERO - {filmes.genero}</p>
                <p>FORMATO - Pdf</p>
              </div>
            ...
            <div className="description-id">
              ...
              <a href={filmes.linkfilmes}><div className="button-livro-id"><button>ASSISTIR <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-btn-fill" viewBox="0 0 16 16">
...
export default FilmesDestaquePorId