...
const filmesPorIdRoutes = () => {
    ...
    useEffect(()=>{ 
      ...
      const fetchUsers = async () => { 
       ...
       await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeacao4/${user}`, {
           method:'GET',
           headers:{
...
fetchUsers();
  ...
  return (
    <div className="Acao">
          ...
          <Link className='Voltar' to='/filmes/acaos'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
