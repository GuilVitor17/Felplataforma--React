...
import BuscarFilmes from "./BuscarFilmesDestaque";
import BuscarFilmes1 from "./BuscarFilmes1";
import BuscarFilmes2 from "./BuscarFilmes2";
import BuscarFilmes3 from "./BuscarFilmes3";
import BuscarFilmes4 from "./BuscarFilmes4";
import BuscarFilmes5 from "./BuscarFilmes5";
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeromance`, {
                    method: 'GET',
                    headers: {
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeromance1`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeromance2`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeromance3`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeromance4`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
    ...
    return (
        ...
        <div className="BuscarLivro">
            ...
            <div class="container-fluid">
                <input class="form-control me-2" type="search" onChange={handlechange} placeholder="Buscar Filmes Romance" aria-label="Search" />
            </div>
