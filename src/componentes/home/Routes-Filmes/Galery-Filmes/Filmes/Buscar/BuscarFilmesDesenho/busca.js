    ...
    useEffect(() => {
        const fetchUsers = async () => {
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmedesenho2`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmedesenho3`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmedesenho4`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmedesenho5`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
    ...
    return (
        ...
        <div className="BuscarLivro">
            ...
            <div class="container-fluid">
                <input class="form-control me-2" type="search" onChange={handlechange} placeholder="Buscar Filmes Desenho" aria-label="Search" />
            </div>
