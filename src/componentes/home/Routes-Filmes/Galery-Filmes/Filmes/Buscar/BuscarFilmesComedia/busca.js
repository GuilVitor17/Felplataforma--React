    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia`, {
                    method: 'GET',
                    headers: {
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia1`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia2`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia3`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmecomedia4`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
    ...
    return (
        ...
        <div className="BuscarLivro">
            ...
            <div class="container-fluid">
                <input class="form-control me-2" type="search" onChange={handlechange} placeholder="Buscar Filmes Comedia" aria-label="Search" />
            </div>
