...
import FilmesTerror from '../../Filmes/Terror/terror'

const FilmesPorIdDrama = () => {
  ...
  useEffect(()=>{ 
    const fetchUsers = async () => { 
     ...
     await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmedrama/${id}`, {
        method:'GET',
        headers:{
...
export default FilmesPorIdDrama;