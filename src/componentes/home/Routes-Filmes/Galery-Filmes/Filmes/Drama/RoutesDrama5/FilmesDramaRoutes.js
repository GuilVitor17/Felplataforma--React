...
const FilmesDramaInfomacoesRoutes = ({titulo, img,Id ,descricaoMin, data}) => {
    ...
    <div className="Drama">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="Btn-livro" to={`/filmes/dramas5/${Id}`}><button type="button" onClick={saveId} className="btn btn-primary">
...
export default FilmesDramaInfomacoesRoutes