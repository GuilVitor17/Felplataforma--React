...
import FilmesDrama from '../../Filmes/Drama/Drama'


const filmesPorIdTerror = () => {
  ...
  useEffect(() => {
    ...
    const fetchUsers = async () => {
      try {
        ...
        await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/filmeterror/${user}`, {
          method: 'GET',
          headers: {
...
export default filmesPorIdTerror;