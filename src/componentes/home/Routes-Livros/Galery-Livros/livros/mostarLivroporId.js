...
const MostrarLivrosPorId= ({titulo, img, descricao, ano, editora, pagina, nameImg, genero, linkLivro}) => {
                  ...
                  <div className="modal-header">
                    ...
                    <div className="InfomacoesLivro">
                      <h5 className="modal-title fs-6" id="staticBackdropLabel">TITULO -
                       {titulo}</h5>
                      <h5 className="modal-title fs-6" id="staticBackdropLabel">AUTOR - {editora} </h5>
...
export default MostrarLivrosPorId