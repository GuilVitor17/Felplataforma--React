...
import LivrosHistoriaInfomacoesBusca from "./buscarLivrosHistoriadestaque";
import LivrosHistoriaInfomacoesBusca1 from "./buscarLivrosHistoria1";
import LivrosHistoriaInfomacoesBusca2 from "./buscarLivrosHistoria2";
import LivrosHistoriaInfomacoesBusca3 from "./buscarLivrosHistoria3";
import LivrosHistoriaInfomacoesBusca4 from "./buscarLivrosHistoria4";
import LivrosHistoriaInfomacoesBusca5 from "./buscarLivrosHistoria5";
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/historia`, {
                    method: 'GET',
                    headers: {
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/historia1`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/historia2`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/historia3`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/historia4`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/historia5`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
    ...
    return (
        ...
        <div className="BuscarLivro">
            ...
            <div class="container-fluid">
                <input class="form-control me-2" type="search" onChange={handlechange} placeholder="Buscar Livro Historia" aria-label="Search" />
            </div>
  ...
  livros.map((livros) => (
    ...
    />
                ...
                >
                    ...
                    {livros1.length > 0 &&
                        livros1.map((livros1) => (
                            <LivrosHistoriaInfomacoesBusca1
  ...
  livros1.map((livros1) => (
    ...
    />
                ...
                >
                    ...
                    {livros2.length > 0 &&
                        livros2.map((livros2) => (
                            <LivrosHistoriaInfomacoesBusca2
  ...
  livros2.map((livros2) => (
    ...
    />
                ...
                >
                    ...
                    {livros3.length > 0 &&
                        livros3.map((livros3) => (
                            <LivrosHistoriaInfomacoesBusca3
  ...
  livros3.map((livros3) => (
    ...
    />
                ...
                >
                    ...
                    {livros4.length > 0 &&
                        livros4.map((livros4) => (
                            <LivrosHistoriaInfomacoesBusca4
  ...
  livros4.map((livros4) => (
    ...
    />
                ...
                >
                    ...
                    {livros5.length > 0 &&
                        livros5.map((livros5) => (
                            <LivrosHistoriaInfomacoesBusca5
