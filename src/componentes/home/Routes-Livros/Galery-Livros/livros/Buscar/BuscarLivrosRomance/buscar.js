...
import LivrosRomanceInfomacoesBusca from "./buscarLivrosRomancedestaque";
import LivrosRomanceInfomacoesBusca1 from "./buscarLivrosRomance1";
import LivrosRomanceInfomacoesBusca2 from "./buscarLivrosRomance2";
import LivrosRomanceInfomacoesBusca3 from "./buscarLivrosRomance3";
import LivrosRomanceInfomacoesBusca4 from "./buscarLivrosRomance4";
import LivrosRomanceInfomacoesBusca5 from "./buscarLivrosRomance5";
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/romance2`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/romance4`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/romance5`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
    ...
    return (
        ...
        <div className="BuscarLivro">
            ...
            <div class="container-fluid">
                <input class="form-control me-2" type="search" onChange={handlechange} placeholder="Buscar Livro Romance" aria-label="Search" />
            </div>
