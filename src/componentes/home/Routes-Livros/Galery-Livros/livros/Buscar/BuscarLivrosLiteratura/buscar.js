...
import LivrosLiteraturaInfomacoesBusca from "./buscarLivrosLiteraturadestaque";
import LivrosLiteraturaInfomacoesBusca1 from "./buscarLivrosLiteratura1";
import LivrosLiteraturaInfomacoesBusca2 from "./buscarLivrosLiteratura2";
import LivrosLiteraturaInfomacoesBusca3 from "./buscarLivrosLiteratura3";
import LivrosLiteraturaInfomacoesBusca4 from "./buscarLivrosLiteratura4";
import LivrosLiteraturaInfomacoesBusca5 from "./buscarLivrosLiteratura5";
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/literatura`, {
                    method: 'GET',
                    headers: {
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/literatura1`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/literatura2`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/literatura3`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/literatura4`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
            ...
            try {
                ...
                await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/literatura5`, {
                    method: 'GET',
                    headers: {
                        'Content-Type': 'aplication/json',
                    }
    ...
    return (
        ...
        <div className="BuscarLivro">
            ...
            <div class="container-fluid">
                <input class="form-control me-2" type="search" onChange={handlechange} placeholder="Buscar Livro Literatura" aria-label="Search" />
            </div>
            ...
            <div className="buscaname">
                ...
                >
                    ...
                    {livros.length > 0 &&
                        livros.map((livros) => (
                            <LivrosLiteraturaInfomacoesBusca
                ...
                >
                    ...
                    {livros1.length > 0 &&
                        livros1.map((livros1) => (
                            <LivrosLiteraturaInfomacoesBusca1
                ...
                >
                    ...
                    {livros2.length > 0 &&
                        livros2.map((livros2) => (
                            <LivrosLiteraturaInfomacoesBusca2
                ...
                >
                    ...
                    {livros3.length > 0 &&
                        livros3.map((livros3) => (
                            <LivrosLiteraturaInfomacoesBusca3
                ...
                >
                    ...
                    {livros4.length > 0 &&
                        livros4.map((livros4) => (
                            <LivrosLiteraturaInfomacoesBusca4
                ...
                >
                    ...
                    {livros5.length > 0 &&
                        livros5.map((livros5) => (
                            <LivrosLiteraturaInfomacoesBusca5
