...
const Buscarlivro = ({titulo, img,Id ,descricaoMin, data}) => {
        ...
        <div className="card-filter">
              ...
              <div className="card">
                ...
                <div className="card-body">
                    ...
                    <h5 className="card-genero-3"><b>Infantil</b></h5>
                    <h5 className="card-date">{data}</h5>
                    <Link className="Btn-livro" to={`/livros/infantil2/${Id}`}><button type="button" onClick={saveId} className="btn btn-primary">
