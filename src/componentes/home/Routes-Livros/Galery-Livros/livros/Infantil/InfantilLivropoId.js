...
import InfantilLivross from "../Infantil/Infantil";


const LivrosPorIdInfantil = () => {
    ...
    useEffect(()=>{ 
      ...
      const fetchUsers = async () => { 
       ...
       await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/infantil/${user}`, {
           method:'GET',
           headers:{
...
export default LivrosPorIdInfantil;