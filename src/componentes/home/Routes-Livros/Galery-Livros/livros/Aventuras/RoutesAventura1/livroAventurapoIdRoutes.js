...
import ReligiaoLivros from "../../Religiao/religiao";
...
const LivrosPorIdRoutes = () => {
    ...
    useEffect(()=>{ 
      ...
      const fetchUsers = async () => { 
       ...
       await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/aventura1/${user}`, {
           method:'GET',
           headers:{
...
fetchUsers();
  ...
  return (
    <div className="Aventura">
          ...
          <Link className='Voltar' to='/livros/aventuras'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
