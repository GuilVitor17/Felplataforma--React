...
import LivrosAventuraInfomacoesRoutes from "../RoutesAventura2/AventuraRoutes";

const AventurasLivrosRoutes = () => {
...
fetchUsers();
  ...
  return (
    <div className="Aventura-livros">
     ...
     {livros.length > 0 &&
       livros.map((livros) => (
         <LivrosAventuraInfomacoesRoutes
...
export default AventurasLivrosRoutes