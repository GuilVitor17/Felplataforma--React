...
import InfantilLivros from "../../Infantil/Infantil";
import { Link } from "react-router-dom";


const LivrosPorIdRoutes = () => {
    ...
    useEffect(()=>{ 
      ...
      const fetchUsers = async () => { 
       ...
       await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/literatura3/${user}`, {
           method:'GET',
           headers:{
...
fetchUsers();
  ...
  return (
    <div className="Literatura">
          ...
          <Link className='Voltar' to='/livros/literaturas'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
...
export default LivrosPorIdRoutes