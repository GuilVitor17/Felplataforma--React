...
const LivrosHistoriaInfomacoesRoutes = ({titulo, img,Id ,descricaoMin, data}) => {
    ...
    <div className="Historia">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="Btn-livro" to={`/livros/historia3/${Id}`}><button type="button" onClick={saveId} className="btn btn-primary">
...
export default LivrosHistoriaInfomacoesRoutes