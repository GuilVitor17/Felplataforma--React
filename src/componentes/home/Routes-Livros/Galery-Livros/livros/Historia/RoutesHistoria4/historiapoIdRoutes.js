...
const LivrosPorIdRoutes = () => {
    ...
    useEffect(()=>{ 
      ...
      const fetchUsers = async () => { 
       ...
       await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/historia4/${user}`, {
           method:'GET',
           headers:{
...
fetchUsers();
  ...
  return (
    <div className="Historia">
          ...
          <Link className='Voltar' to='/livros/historias'><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-arrow-left-square" viewBox="0 0 16 16">
