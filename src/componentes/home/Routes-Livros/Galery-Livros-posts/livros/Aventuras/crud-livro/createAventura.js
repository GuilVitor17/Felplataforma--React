...
import './crud-modules.css'
import Swal from 'sweetalert2/dist/sweetalert2.js'

const createAventura = () => {
  ...
  const aoSalvar = (evento) => {
    ...
    axios.post(`${process.env.REACT_APP_BASE_URL_GALERY}/aventura`, {
      titulo: Titulo,
      autor: Autor,
      pagina: Pagina,
      descricaoMin: Descricao,
      descricao: DescricaoMin,
      data: Data,
      img: Img,
      linkLivro: LinkLivro,
      ano: Ano,
  ...
  return (
    <section className="formulario">
      <form class="row g-3" onSubmit={aoSalvar}>
        ...
        <h5>publicar livro em Aventura</h5>
        <div class="col-md-6">
        ...
        <div class="col-12">
          ...
          <input type="text" class="form-control" maxLength={150} onChange={handleDescricao} required placeholder="DESCRIÇAO DETALHADA DO LIVRO" value={Descricao} id="inputAddress2" />
        </div>
        <div class="col-md-6"> 
