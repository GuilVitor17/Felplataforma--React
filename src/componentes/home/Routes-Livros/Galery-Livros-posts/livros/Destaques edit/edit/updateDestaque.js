...
const LivrosUpdateDestaque = (LivrosUpdate) => {
    ...
    const handleImgCapa = (e) => {
        setImgCapa(e.target.value)
    ...
    const Update = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_BASE_URL_GALERY}/livroscarrossel/${id}`, {
            titulo: Titulo,
            autor: Autor,
            pagina: Pagina,
            ...
            await Swal.fire({
                position: 'top-end',
                icon: 'success',
                title: `LIVRO DESTAQUE ATUALIZADO`,
        ...
        <section className="formulario">
            <div>
                <form class="row g-3" onSubmit={Update}>
                    ...
                    <h6>EDITAR LIVRO EM DESTAQUE</h6>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" onChange={handleDescricaoMin} maxLength={70} placeholder='DESCRIÇÃO MINIMA DO LIVRO' value={DescricaoMin} class="form-control" id="inputEmail4" />
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label for="inputEmail4" class="form-label">Url da Imagem-CAPA</label>
                        <input type="text" onChange={handleImgCapa} placeholder="URL - MAX 50KB" value={ImgCapa} class="form-control" id="inputEmail4" />
                    </div>
                    <div class="col-6">
                        <label for="inputAddress2" class="form-label">Descrição Detalhada</label>
                        <input type="text" class="form-control" maxLength='200' onChange={handleDescricao} required placeholder="DESCRIÇAO DETALHADA DO LIVRO" value={Descricao} id="inputAddress2" />
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <label for="inputCity" class="form-label">Genero do livro</label>
                        <input type="text" onChange={handlegenero} required placeholder="GENERO DO LIVRO" value={genero} class="form-control" id="inputCity" />
                    </div>

                    <div class="col-6">
                        <button type="submit" class="btn btn-primary">CRIAR LIVRO DE Destaque</button>
...
export default LivrosUpdateDestaque