...
const LivrosReligiaoInfomacoes = ({titulo, img,Id ,descricaoMin, data}) => {
     ...
     axios.delete(`${process.env.REACT_APP_BASE_URL_GALERY}/religiao/${Id}`, {
  
})
.then(async response => {
  let timerInterval
          await Swal.fire({
            title: 'EXCLUINDO LIVRO RELIGIAO !',
            html: 'AGUARDE <b></b>',
            timer: 2000,
    ...
    <div className="Religiao">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="button-editar" to={`updatereligiao/${Id}`}><button>Editar</button></Link>
