...
const ReligiaoLivross = () => {
  ...
  useEffect(()=>{ 
    const fetchUsers = async () => { 
     ...
     await fetch(`${process.env.REACT_APP_BASE_URL_GALERY}/religiao1`, {
        method:'GET',
        headers:{
...
fetchUsers();
  ...
  return (
    <div className="Religiao-livros">
       ...
       <Link className="button-criar" to='/posts/livros/religiaocreatePost1'><button>CRIAR LIVRO Religiao 1</button></Link>
