...
const LivrosHistoriaInfomacoes = ({titulo, img,Id ,descricaoMin, data}) => {
 ...
 axios.delete(`${process.env.REACT_APP_BASE_URL_GALERY}/historia/${Id}`, {
  
})
.then(async response => {
  let timerInterval
          await Swal.fire({
            title: 'EXCLUINDO LIVRO HISTORIA !',
            html: 'AGUARDE <b></b>',
            timer: 2000,
    ...
    <div className="Historia">
              ...
              <div className="card">
                ...
                <h6 className="card-text">{descricaoMin}</h6>
                  ...
                  <Link className="button-editar" to={`updatehistoria/${Id}`}><button>Editar</button></Link>
