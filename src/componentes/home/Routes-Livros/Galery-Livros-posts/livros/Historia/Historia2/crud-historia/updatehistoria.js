...
const LivrosUpdateHistoria = (LivrosUpdate) => {
    ...
    const Update = (e) => {
        ...
        axios.put(`${process.env.REACT_APP_BASE_URL_GALERY}/historia2/${id}`, {
            titulo: Titulo,
            autor: Autor,
            pagina: Pagina,
        ...
        await Swal.fire({
            position: 'top-end',
            icon: 'success',
            title: `LIVRO HISTORIA 2 ATUALIZADO`,
        ...
        <section className="formulario">
            <div>
                <form class="row g-3" onSubmit={Update}>
                    ...
                    <h5>Editar livro em HISTORIA 2</h5>
                    <div class="col-md-6">
                 ...
                 <input type="text" class="form-control" onChange={handleDescricao} required placeholder="DESCRIÇAO DETALHADA DO LIVRO" maxLength={150}  value={Descricao} id="inputAddress2" />
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">CRIAR LIVRO DE HISTORIA 2</button>
