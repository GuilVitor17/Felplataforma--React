    ...
    <div className="Destaque">
      ...
      <div class="card text-bg-dark">
        ...
        <div class="card-img-overlay">
          ...
          <h6 class="card-title"><b>DESTAQUES</b></h6>
          <h5 class="card-text">{descricaoMin}</h5>
          <h5 class="card-textt-data"><small>{data}</small></h5>
          <Link className="Btn-livro-destaque" to={`/logosdestaque/${Id}`}><button type="button" onClick={saveId} className="btn btn-primary">
          Ver filmes
        </button></Link>
        <h5 class="card-genero">{genero}</h5>
        <Link className="button-editar-destaque" to={`updatedestaquefilmes/${Id}`}><button>Editar</button></Link>
        </div>
      </div>
